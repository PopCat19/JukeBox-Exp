      ...
      parserOptions: {
        projectService: {
          allowDefaultProject: [
            ...
            "synth/socket/capability-schema.ts",
            ...
            "synth/modules/custom-chip-wave/schema.ts",
            "synth/modules/custom-chip-wave/serde.ts",
            "synth/modules/custom-chip-wave/dsp.ts",
            "synth/modules/custom-chip-wave/module.ts",
            "tests/serde-container.test.ts",
            "tests/legacy-importer.test.ts",
            "tests/placeholder-module.test.ts",
            "tests/url-varint.test.ts",
            "tests/modules-pulse.test.ts",
            "synth/modules/pulse/schema.ts",
            "synth/modules/pulse/serde.ts",
            "synth/modules/pulse/dsp.ts",
            "synth/modules/noise/schema.ts",

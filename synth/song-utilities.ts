...
export function parseAndConfigureCustomSample(url: string, customSampleUrls: string[], customSamplePresets: PresetLike[], loadingState: SampleLoadingState, parseOldSyntax: boolean): boolean {

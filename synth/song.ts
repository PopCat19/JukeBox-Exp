...
import { toBase64StringImpl, fromBase64StringImpl, toJsonObjectImpl, fromJsonObjectImpl } from "./song-serialization";
...
export class Song {
    ...
    public toJsonObject = (enableIntro?: boolean, loopCount?: number, enableOutro?: boolean): object => toJsonObjectImpl(this as any, enableIntro, loopCount, enableOutro);

...
import { Instrument, FilterControlPoint, FilterSettings } from "./instruments";
import { Tone } from "./tone";
import { EnvelopeComputer } from "./envelope-computer";
import { tempFilterStartCoefficients, tempFilterEndCoefficients, instrumentVolumeToVolumeMult } from "./synth-shared";
        ...
        */
        ...
        if (instrument.eqFilterType) {
            ...
            if (filterChanges) {
                ...
                this.eqFilters[0].loadCoefficientsWithGradient(tempFilterStartCoefficients, tempFilterEndCoefficients, 1.0 / roundedSamplesPerTick, startPoint.type == FilterType.lowPass);
                ...
                if (this.eqFilters.length < 1) this.eqFilters[0] = new DynamicBiquadFilter();
                this.eqFilters[0].loadCoefficientsWithGradient(tempFilterStartCoefficients, tempFilterStartCoefficients, 1.0 / roundedSamplesPerTick, startPoint.type == FilterType.lowPass);
            ...
            for (let i: number = 0; i < eqFilterSettings.controlPointCount; i++) {
                ...
                const endPoint: FilterControlPoint = (instrument.tmpEqFilterEnd != null && instrument.tmpEqFilterEnd.controlPoints[i] != null) ? instrument.tmpEqFilterEnd.controlPoints[i] : eqFilterSettings.controlPoints[i];
                ...
                this.eqFilters[i].loadCoefficientsWithGradient(tempFilterStartCoefficients, tempFilterEndCoefficients, 1.0 / roundedSamplesPerTick, startPoint.type == FilterType.lowPass);
                eqFilterVolume *= startPoint.getVolumeCompensationMult();

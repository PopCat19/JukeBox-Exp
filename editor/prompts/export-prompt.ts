...
import { InstrumentType, /*EnvelopeType,*/ Config, getArpeggioPitchIndex } from "../../synth/synth-config";
import { Instrument, Pattern, Note, Song, Synth } from "../../synth";
...
import { MidiChunkType, MidiFileFormat, MidiControlEventMessage, MidiEventType, MidiMetaEventMessage, MidiRegisteredParameterNumberMSB, MidiRegisteredParameterNumberLSB, volumeMultToMidiVolume, volumeMultToMidiExpression, defaultMidiPitchBend, defaultMidiExpression } from "../io/midi";

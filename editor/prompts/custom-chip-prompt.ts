...
export class CustomChipPromptCanvas {
	...
	public readonly container: HTMLElement = HTML.div(
		{
			class: "chipCanvasWrap pmd-surface",
			role: "img",
			tabIndex: "0",
			"aria-label": "Custom chip waveform editor",
			"aria-describedby": "custom-chip-waveform-instructions",
			title: "Draw custom chip waveform",
		},
		this._svg,
	);
...
export class CustomChipPrompt extends BasePrompt {
	...
	public readonly container: HTMLDivElement = div(
		...
		p(
			{ id: "custom-chip-waveform-instructions", class: "screen-reader-only" },
			"Use pointer or touch input to draw waveform samples.",
		),

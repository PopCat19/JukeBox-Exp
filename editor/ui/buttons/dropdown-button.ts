...
import { Animation, Typography } from "../style-constants";
...
const baseStyle = `margin-left:0em; height:1.5em; width: 10px; padding: 0px; font-size: ${Typography.sizeXs}; display: flex; align-items: center; justify-content: center; transition: opacity ${Animation.durationFast}; opacity: 0.7;`;

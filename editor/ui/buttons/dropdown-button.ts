...
const baseStyle = "margin-left:0em; width: 18px; height: 18px; padding: 4px; font-size: 8px; display: flex; align-items: center; justify-content: center; border-radius: 50%; transition: opacity 0.1s; opacity: 0.7;";

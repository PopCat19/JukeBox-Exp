...
const baseStyle =
	"margin-left:0em; height:1.5em; width: 10px; padding: 0px; font-size: 8px; display: flex; align-items: center; justify-content: center; transition: opacity 0.1s; opacity: 0.7;";

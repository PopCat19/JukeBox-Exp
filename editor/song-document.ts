...
export class SongDocument {
  ...
  public getBarWidth(): number {
    ...
    return (!this.getMobileLayout() && this.prefs.enableChannelMuting
  ...
  public getChannelHeight(): number {
    const squashed: boolean = this.getMobileLayout() || this.song.getChannelCount() > 4
    ...
    const megaSquashed: boolean = !this.getMobileLayout()
      && (((this.prefs.layout != "wide") && this.song.getChannelCount() > 11) || this.song.getChannelCount() > 22);

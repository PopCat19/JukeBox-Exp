...
export class MenuBar {
	...
	constructor() {
		...
		this.editMenu = select(
			...
			option({ value: "cleanPatternsCurrent" }, "Clean Patterns, Current Channel (LSDj)"),
			option({ value: "cleanPatternsAll" }, "Clean Patterns, All Channels (LSDj)"),
			option({ value: "cleanInstrumentsCurrent" }, "Clean Instruments, Current Channel (LSDj)"),
			option({ value: "cleanInstrumentsAll" }, "Clean Instruments, All Channels (LSDj)"),

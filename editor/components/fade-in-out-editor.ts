// FadeInOutEditor
//
// Purpose: Renders editor UI for configuring instrument fade-in and fade-out envelopes
//
// This module:
// - Draws fade-in/out curve visualization
// - Handles fade setting adjustments
...
export class FadeInOutEditor {
  ...
  private _xToFadeOut(x: number) {
    return clamp(
      ...
      Math.round((Config.fadeOutTicks.length - 1) * ((x - 1.0) / (this._editorWidth - 2.0) - 0.5) / 0.5),
    );
  }

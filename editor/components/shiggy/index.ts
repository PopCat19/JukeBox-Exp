...
export class Shiggy {
    ...
    constructor() {
        ...
        this._img.ontouchend = () => { this._isPetting = false; };
        this._img.ontouchcancel = () => { this._isPetting = false; };
        ...
        this._img.onmouseup = () => { this._isPetting = false; };
        this._img.onmouseleave = () => { this._isPetting = false; };

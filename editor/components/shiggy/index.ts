...
export class Shiggy {
  ...
  constructor() {
    ...
    this._img.style.cssText =
      "width: 60px; height: auto; pointer-events: auto; opacity: 0; transition: opacity 0.2s; cursor: pointer;";
    ...
    this._counter.style.cssText =
      "font-size: 10px; color: var(--secondary-text); opacity: 0; transition: opacity 0.3s; min-height: 1.2em;";

...
import { Preset, presetCategoriesData, PresetCategory } from "./preset-categories";
...
export class EditorConfig {
  ...
  public static readonly isOnMac: boolean = /^Mac/i.test(navigator.platform) || /Mac OS X/i.test(navigator.userAgent)

...
- `import-export-pane.ts` - Native stacked song and instrument import/export surface ownership
...
- `navigator-shell.ts` - Searchable flat PMD route workspace and attached pane host

...
export class PlayerControls {
	...
	get synth() { return this.ui.synth; }
	...
	public init(): void {
		...
		this.ui.copyLink.addEventListener("click", (e) => { e.preventDefault(); this.onCopyClicked(); });
		this.ui.shareLink.addEventListener("click", (e) => { e.preventDefault(); this.onShareClicked(); });
